...
namespace smartest_desktop.Services
{
    ...
    public class GroqService
    {
        ...
        public static string BuildPromptQcmLot(string contenuCours, int nbQuestions, int numeroDepart, IReadOnlyList<string>? avoid = null)
        {
...
Output ONLY the JSON array, nothing else.";
        ...
        private static string GetDifficultyInstructions(string difficulte) => difficulte switch
        {
            ...
            "Difficile" =>
                ...
                "- For CHECKBOX, include 3 or 4 correct answers to increase difficulty\n" +
            ...
            IReadOnlyList<string>? avoid = null)
        {
            ...
            sb.AppendLine();
            sb.AppendLine("QCM format (use for EXACTLY " + nbQCM + " questions):");
            sb.AppendLine("{\"type\":\"QCM\",\"enonce\":\"Question?\",\"optionA\":\"...\",\"optionB\":\"...\",\"optionC\":\"...\",\"optionD\":\"...\",\"reponseCorrecte\":\"A\",\"explication\":\"...\"}");
            if (nbCheckbox > 0)
            {
                sb.AppendLine();
                sb.AppendLine("CHECKBOX format (use for EXACTLY " + nbCheckbox + " questions, multiple correct answers):");
                sb.AppendLine("{\"type\":\"CHECKBOX\",\"enonce\":\"Question?\",\"optionA\":\"...\",\"optionB\":\"...\",\"optionC\":\"...\",\"optionD\":\"...\",\"reponsesCorrectes\":[\"A\",\"C\"],\"explication\":\"...\"}");
            }
            if (nbRedaction > 0)
            {
                sb.AppendLine();
                sb.AppendLine("REDACTION format (use for EXACTLY " + nbRedaction + " questions, open answer):");
                sb.AppendLine("{\"type\":\"REDACTION\",\"enonce\":\"Question?\",\"reponseModele\":\"Detailed model answer...\",\"explication\":\"...\"}");
            }
            sb.AppendLine();
            sb.AppendLine("RULES:");
        ...
        public static string BuildPromptExamen(
            ...
            string difficulte)
        {
            return BuildPromptExamenLot(contenuCours, nbQCM, nbCheckbox, nbRedaction, difficulte, 1, null);
        }
    }
}